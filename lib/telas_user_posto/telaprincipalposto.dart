...
// TELA PRINCIPAL
//
class TelaPrincipalPosto extends StatefulWidget {
  @override
  _TelaPrincipalPostoState createState() => _TelaPrincipalPostoState();
}

class _TelaPrincipalPostoState extends State<TelaPrincipalPosto> {
